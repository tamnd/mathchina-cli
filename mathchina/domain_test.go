...
// HTTP behaviour is covered in mathchina_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "mathchina://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mathchina", "about")
	if err != nil || got.String() != "mathchina://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mathchina://page/about", got.String(), err)
	}
}
